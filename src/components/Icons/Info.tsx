...
const Info = ({ active }: IActiveableProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="32" viewBox="0 0 32 32" width="32">
      <g transform="translate(122.702 -583.545)">
        <path style={{ fill: active ? activeColor : inactiveColor }} d="m-91.1 599.545a15.6 15.6 0 0 1 -15.6 15.6 15.6 15.6 0 0 1 -15.6-15.6 15.6 15.6 0 0 1 15.6-15.6 15.617 15.617 0 0 1 15.6 15.6zm-2.08 0a13.52 13.52 0 0 0 -13.52-13.52 13.52 13.52 0 0 0 -13.52 13.52 13.52 13.52 0 0 0 13.52 13.52 13.535 13.535 0 0 0 13.518-13.52z"/>
