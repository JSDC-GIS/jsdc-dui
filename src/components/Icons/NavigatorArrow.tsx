    ...
    <svg id="nav-icon" xmlns="http://www.w3.org/2000/svg" width="25" height="25.005" viewBox="0 0 25 25.005">
      <defs>
        <clipPath id="NavigatorArrow-clip-path">
          <rect data-name="Rectangle 1067" width="25" height="25.005" transform="translate(0 0)" fill="none" />
        </clipPath>
      </defs>
      <g id="Group_943" data-name="Group 943" transform="translate(0 0)">
        <g id="Group_947" data-name="Group 947" clipPath="url(#NavigatorArrow-clip-path)">
