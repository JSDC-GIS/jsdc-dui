...
export const BASEMAPS = {
  ...
  石門水利會1965年灌溉區域圖:
    'http://gis.sinica.edu.tw/taoyuan/file-exists.php?img=shimen_IR4-png-{z}-{x}-{y}',
  '桃園水利會灌溉區域圖(1999)':
    'http://gis.sinica.edu.tw/taoyuan/file-exists.php?img=Taoyaun_Irrigation_1999-png-{z}-{x}-{y}',
  ...
  '嘉南大圳平圖(1933)':
    'http://gis.sinica.edu.tw/tainan/file-exists.php?img=chianan_100K_1933-png-{z}-{x}-{y}',
  '魯地圖 Taiwan TOPO':
    'https://rs.happyman.idv.tw/map/moi_osm/{z}/{x}/{y}.png',
  '1934-日治三十萬分之一台灣全圖	':
    'https://gis.sinica.edu.tw/tileserver/file-exists.php?img=JM300K_1934-jpg-{z}-{x}-{y}',
  '1916-日治蕃地地形圖':
    'https://gis.sinica.edu.tw/tileserver/file-exists.php?img=JM50K_1916-jpg-{z}-{x}-{y}',
  '1904-日治臺灣堡圖(明治版)':
    'https://gis.sinica.edu.tw/tileserver/file-exists.php?img=JM20K_1904-jpg-{z}-{x}-{y}',
  '1897-日治臺灣假製二十萬分一圖	':
    'https://gis.sinica.edu.tw/tileserver/file-exists.php?img=JM200K_1897_new-png-{z}-{x}-{y}',
}
